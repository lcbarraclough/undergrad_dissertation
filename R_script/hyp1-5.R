...
#The aim of this script is to reproduce the graphs from script hyp1-4 but without the
#counts for the ants.
...
mean_table1.2 <- mean_table1.2 %>% 
  mutate(mean_table1.2, sd = c(1.83, 4.27, 2.84)) #entering sd values manually
